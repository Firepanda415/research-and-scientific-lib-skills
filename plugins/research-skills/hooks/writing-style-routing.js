...
Before planning a deliverable such as a document, code, or an analysis, infer what the requester intends, who will read or use the result, and what those readers or users come to it for. Keep to the scope the requester intended, and let that audience's need decide what to research, include, or build. Stop gathering once the need is met, since filtering afterwards does not undo the cost of collecting. A claim's evidence standard sets how carefully it is checked, and the audience's need sets how many claims to seek. Briefs to other agents state the audience, the question or task, and when to stop.
