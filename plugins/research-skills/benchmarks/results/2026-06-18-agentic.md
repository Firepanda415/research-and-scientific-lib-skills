> Archived report by Dietrich Gebert from [Ponytail](https://github.com/DietrichGebert/ponytail), under the [MIT License](../../PONYTAIL-LICENSE). The reproduction link below points to upstream because benchmark runners are not bundled here. This is not a benchmark of research-skills.
...
See [`benchmarks/agentic/README.md`](https://github.com/DietrichGebert/ponytail/blob/356918eba965ee1eac64bd3a7f0dd02108350de5/benchmarks/agentic/README.md). Short version: clone the template at
