...
## Illustrative briefing entry

One possible top-five entry for this paper. Its length, sentence pattern, and phrasing are not a template. `references/output-template.md` sets the structure.
