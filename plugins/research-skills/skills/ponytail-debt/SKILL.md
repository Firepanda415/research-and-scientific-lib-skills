...
name: ponytail-debt
description: >
  Collect deliberate `ponytail:` shortcut and deferral comments into a debt
  ledger. Use for Ponytail debt or shortcut inventory requests. Read-only and one-shot.
---
