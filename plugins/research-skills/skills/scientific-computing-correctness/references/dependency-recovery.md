...
In authorized remediation, remove unsupported automatic retries and work with no required result or evidence consumer. Before extra costly validation, read and apply the [resource approval rules](../SKILL.md#resource-proportionality). Do not run a benchmark merely to justify a retry.
