...
For these tasks, read [durable prose](references/durable-prose.md) as the shared writing criteria. Another skill's document, research, or publishing workflow does not replace this requirement. Loading instructions without applying them is insufficient. Improvements incorporated into these generation and review criteria apply to every covered task, including lessons from rewriting trials. They require no detector request or score. External detector testing follows the separate optional workflow below.
